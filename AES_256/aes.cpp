...
ByteArray::size_type AES::encrypt(const ByteArray& key, const ByteArray& plain, ByteArray& encrypted)
{
    AES aes(key);
...
ByteArray::size_type AES::encrypt(const ByteArray& key, const unsigned char* plain, const ByteArray::size_type plain_length, ByteArray& encrypted)
{
    AES aes(key);
...
ByteArray::size_type AES::decrypt(const ByteArray& key, const ByteArray& encrypted, ByteArray& plain)
{
    AES aes(key);
...
ByteArray::size_type AES::decrypt(const ByteArray& key, const unsigned char* encrypted, const ByteArray::size_type encrypted_length, ByteArray& plain)
{
    AES aes(key);
...
ByteArray::size_type AES::encrypt_continue(const ByteArray& plain, ByteArray& encrypted)
{
...
ByteArray::size_type AES::encrypt_continue(const unsigned char* plain, const ByteArray::size_type plain_length, ByteArray& encrypted)
{
...
void AES::check_and_encrypt_buffer(ByteArray& encrypted)
{
...
ByteArray::size_type AES::decrypt_continue(const ByteArray& encrypted, ByteArray& plain)
{
...
ByteArray::size_type AES::decrypt_continue(const unsigned char* encrypted, const ByteArray::size_type encrypted_length, ByteArray& plain)
{
    ByteArray::size_type i = 0;
...
void AES::check_and_decrypt_buffer(ByteArray& plain)
{
